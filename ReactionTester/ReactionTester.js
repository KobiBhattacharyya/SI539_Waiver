...
function locationGenerator()
{
    ...
    var difference = (windowHeight - bodyHeight)/windowHeight*100;
    var top = (Math.floor(Math.random()*difference) + bodyHeight/windowHeight*100).toString()+"%";
...
function executeGame()
{
    ...
    document.getElementById("shape").onclick = function()
    {
        ...
        if(totalTime<fastest || fastest == null) {
            fastest = totalTime;
            document.getElementById("fastest").innerHTML = "Fastest time: "+fastest;
        }
        avg.push(totalTime);
